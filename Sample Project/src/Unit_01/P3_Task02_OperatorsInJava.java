...
/*
 	Operator in Java is a symbol that is used to perform operations on one or more operand to modify value of some variable/s.
 	For Example: +, -, *, /, >, <.......
 	
 	Types of Operators in Java
 	- Unary Operator:			[(Pre-fix and Post-fix) a++,++a,a--,--a,~,!] 
 	- Arithmetic Operator:		[* / % + -] 
 	- Shift Operator:			[<< >>]
 	- Relational Operator:		[< > <= >= !=]
 	- Bitwise Operator:			[& | ^]
