...
/* VARIABLES IN JAVA:
 	A Data container that saves the data values during program execution. A variable is a memory location name of the data.
  
 	Types of Variables:
 	- In Java there are three types of variables:
 
 	* Local Variables: 
 	  - These are declared inside the body of a method
 
 	* Instance Variables:
 	  - These are defined w/o keyword 'static'
